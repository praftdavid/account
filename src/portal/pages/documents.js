...
async function renderList(container) {
  ...
  <div class="card">
    ...
    <div style="overflow-x:auto"><table>
      <tr><th>문서번호</th><th>구분</th><th>제목</th><th>부서</th><th>상태</th><th>작성일</th></tr>
...
async function renderDetail(container) {
  ...
  <div class="card">
    <div class="toolbar">
      ...
      <span class="badge ${STATUS_BADGE[doc.status]}" style="margin-left:10px">${STATUS_LABEL[doc.status]}</span>
    ...
    <table>
      ...
      <tr><th>기안부서</th><td>${esc(deptLabel(departments, doc.dept_id))}</td><th>기안자</th><td>${esc(doc.drafter_email)}</td></tr>
  ...
  if (submitBtn) {
    submitBtn.onclick = async () => {
      ...
      try {
        const doc_no = doc.doc_no ?? (await nextDocNo());
