...
export function renderLetterheadBody(doc, deptName) {
  ...
  return `
<p style="text-align:center;font-family:${FONT_TITLE};font-weight:900;font-size:13px;margin:0 0 6px">${esc(COMPANY.slogan)}</p>
<h1 style="text-align:center;font-family:${FONT_TITLE};font-size:26px;letter-spacing:14px;margin:10px 0 18px;font-weight:900">${esc(COMPANY.name)}</h1>
...
<table style="width:100%;border-collapse:collapse;font-size:14px;margin-bottom:6px">
  ...
  <tr><td style="padding:4px 0;vertical-align:top">제목 :</td><td style="padding:4px 0">${esc(doc.title)}</td></tr>
</table>
